export default [
  ...
  },
  {
    ...
    answer: 'Если к одному элементу применены несколько одинаковых правил, то действовать будут те, чьи селекторы обладают наибольшим весом. Вес селектора считается по следующим правилам: инлайновый селектор - 1000, селектор по id - 100, селектор по классу/атрибуту/псевдоклассу - 10, селектор по тегу/псевдоэлементу - 1. Так же существует специальная директива !important, которая добавляется в конец css-правила и "перебивает" все другие селекторы, но её использование нежелательно',
    topic: 'HTML&CSS', 
  },
  {
  ...
  },
  {
    ...
    answer: 'Адаптивный дизайн - несколько разных макетов, которые загружаются в зависимости от устройства. Отзывчивый - один макет, который перестраивается в зависимости от устройства',
    topic: 'HTML&CSS',  
  },
  {
  ...
  },
  {
    ...
    answer: 'Hoisting - это механизм поднятия переменных и функций на верх области видимости, что дает возможность обращаться к ним ещё до обьявления. Таким механизмом обладают function declaration и переменные var',
    topic: 'JS',  
  },
  {
